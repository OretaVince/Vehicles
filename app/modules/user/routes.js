...
router.get('/', (req, res) => {
     ...
     */
    db.query('SELECT * FROM cars', function (err, results, fields) {
        /**
    ...
    function render(cars) {
        res.render('home/views/index', { cars: vehicles });
    }
});
...
router.post('/new', (req, res) => {
    var db = require('../../lib/database')();
    db.query(`INSERT INTO \`vehicles\` (\`maker\`, \`model\`, \`year\`)  VALUES ("${req.body.maker}", "${req.body.model}", ${req.body.year})`, (err, results, fields) => {
